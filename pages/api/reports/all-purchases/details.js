...
/**
 * GET /api/reports/all-purchases/details?materialKey=XXX&year=2024 (or year=all)
 * Returns all PO line items for the given material: PO number, date, vendor code/name, unit rate, qty, value.
 */
export default async function handler(req, res) {
  ...
  try {
    ...
    console.error("all-purchases details API error:", error);
