...
/**
 * GET /api/reports/channel-partner-purchases/details?materialKey=XXX&year=2024 (or year=all)
 * Returns 71-series PO line items for the given material: PO number, date, vendor code/name, unit rate, qty, value.
 */
export default async function handler(req, res) {
  ...
  try {
    ...
    console.error("channel-partner-purchases details API error:", error);
