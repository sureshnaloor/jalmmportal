...
import { getJobForUser } from '../../../../../lib/delayedPoJob';
import { generateExcelBuffer, generatePdfBuffer } from '../../../../../lib/delayedPoReport';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (format === 'pdf') {
      ...
      filename = `Delayed_PO_Reasons_${timestamp}.pdf`;
    } else {
      buffer = generateExcelBuffer(job.reportData);
      contentType = 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet';
      filename = `Delayed_PO_Reasons_${timestamp}.xlsx`;
    }
    ...
    console.error('Download delayed PO report error:', error);
