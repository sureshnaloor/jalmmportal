...
const CashPOMaterialsDetails = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      setError(null);
      try {
        const url = `/api/reports/cash-po-materials/details?materialKey=${encodeURIComponent(materialKey)}&year=${encodeURIComponent(year)}`;
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <Link href="/cash-po-materials-report" className="text-blue-600 hover:underline mt-2 inline-block">Back to report</Link>
        </div>
        <FooterComponent />
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        <title>Material PO Details (47*) | MM Portal</title>
      </Head>
      <HeaderComponent />
      <div className="container mx-auto px-4 py-8">
        <div className="mb-6 flex items-center justify-between flex-wrap gap-4">
          <div>
            <Link href="/cash-po-materials-report" className="text-blue-600 hover:underline text-sm mb-2 inline-block">← Back to 47 Series Cash PO Materials Report</Link>
            <h1 className="text-2xl font-bold text-gray-900">Material PO Details (47* Cash PO)</h1>
...
export default CashPOMaterialsDetails;
