...
const AllPurchasesDetails = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      setError(null);
      try {
        const url = `/api/reports/all-purchases/details?materialKey=${encodeURIComponent(materialKey)}&year=${encodeURIComponent(year)}`;
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <Link href="/all-purchases-report" className="text-blue-600 hover:underline mt-2 inline-block">Back to report</Link>
        </div>
        <FooterComponent />
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        <title>Material PO Details (All Purchases) | MM Portal</title>
      </Head>
      <HeaderComponent />
      <div className="container mx-auto px-4 py-8">
        <div className="mb-6 flex items-center justify-between flex-wrap gap-4">
          <div>
            <Link href="/all-purchases-report" className="text-blue-600 hover:underline text-sm mb-2 inline-block">← Back to All Purchases Report</Link>
            <h1 className="text-2xl font-bold text-gray-900">Material PO Details (All Purchases)</h1>
...
export default AllPurchasesDetails;
