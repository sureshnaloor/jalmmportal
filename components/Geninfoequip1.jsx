...
function Geninfoform1({ equip }) {
  ...
  return (
    <main className="w-full min-h-full">
      <div className="relative mx-auto w-full min-h-full rounded-lg bg-gradient-to-tr from-blue-50 to-teal-50 p-0.5 shadow-lg">
        <div className=" p-7 rounded-md">
          ...
          <div className="flex justify-start align-middle ">
            <p className="font-semibold text-stone-900 text-lg font-Lato ">
              {" "}
              Technical Name: {equipgeninfo?.geninfo?.technicalname}{" "}
            </p>
          </div>
          ...
          <div className="flex flex-col mb-5 pb-3">
            <p className="text-green-900 font-bold text-lg ">
              {" "}
              Manufacturer:{" "}
              <span className="text-stone-800 tracking-wider">
                {equipgeninfo?.geninfo?.manufacturer}{" "}
              </span>
            </p>
            <p className="text-stone-900 font-semibold text-lg ">
              {" "}
              Model: {equipgeninfo?.geninfo?.model}{" "}
            </p>
            <p className="text-sky-900 font-semibold text-lg">
              {" "}
              Website : {equipgeninfo?.geninfo?.website}{" "}
            </p>
          </div>

          <div className="flex justify-between mb-5 mt-3 align-middle border-b-4 pb-3 border-green-900">
            <h3 className="font-bold text-lg">
              {" "}
              Serial Number: {equipgeninfo?.geninfo?.serialnumber}
            </h3>
            <h5 className="font-semibold text-lg text-amber-900">
              {" "}
              Legacy Number: {equipgeninfo?.geninfo?.legacynumber}
            </h5>
          </div>
          ...
          <div className="text-xl text-green-900 ">
            <h3 className="font-semibold pb-3">
              ...
              <span className="font-thin">
                {" "}
                {equipgeninfo?.geninfo?.accessories}
              </span>
            </h3>
