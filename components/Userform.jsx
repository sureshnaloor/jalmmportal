                ...
                <div>
                  ...
                  <div className="md:flex md:flex-row md:space-x-4 w-full text-xs ">
                    ...
                    <div className="w-full flex flex-col mb-3">
                      <label className="font-semibold text-[12px] text-gray-600 py-2 ">
                        Used in which project:(If
                        warehouse choose Jubail / Dammam)
                      </label>
                      <input
                        placeholder="Project Name"
                        ...
                        name="project"
                        id="project"
                        value={calibprojects.filter(proj=> proj.toLowerCase().includes(projectstr.toLowerCase()))}
                        {...register("project", {
                  ...
                  <div className="w-1/2 flex flex-col mb-3">
                      <label className="font-semibold text-gray-600 text-[12px] py-1">
