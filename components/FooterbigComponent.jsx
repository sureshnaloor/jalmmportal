...
function FooterbigComponent() {
  ...
  return (
    <div>
      <footer className="py-5 px-16 text-gray-100 bg-[#006266] dark:bg-gray-800 my-12">
        <div className="flex flex-col sm:flex-row justify-between pt-8">
          <div className="w-full sm:w-1/2">
            <h1 className="text-2xl font-bold xl:text-4xl sm:text-3xl md:mr-8">
          ...
          <div className="w-full sm:w-1/2">
            ...
            <div className="w-full sm:w-auto flex-none flex flex-col justify-center sm:flex-row sm:items-start space-y-3 space-y-reverse sm:space-y-0 sm:space-x-4 mt-5 mx-auto xl:mx-0">
              <div className="inline-block">
                <button className="w-full lg:w-auto inline-flex items-center justify-center font-medium bg-yellow-700 text-gray-200 py-3 px-5 mb-4 hover:bg-yellow-900 hover:text-white focus:outline-none">
                  Make a request
                </button>
              </div>
              <div className="inline-block">
                <button className="w-full lg:w-auto inline-flex items-center justify-center font-medium border border-yellow-500  py-3 px-5 focus:outline-none hover:bg-yellow-50 hover:text-yellow-700">
                  Schendule site wait
                </button>
              </div>
            </div>
        ...
        <div className="w-full inline-flex mt-12 items-center justify-center mx-auto text-xl font-semibold">
          <img
            ...
            alt=""
            className="w-12 h-12 items-center mr-4"
          />
