...
import DelayedPOReportButton from "./DelayedPOReportButton";
...
import GeneralPOData from './POSchedule/GeneralPOData';
import PaymentScheduleData from './POSchedule/PaymentScheduleData';
import BankGuaranteeData from './POSchedule/BankGuaranteeData';
import LCData from './POSchedule/LCData';
import ProgressMilestoneData from './POSchedule/ProgressMilestoneData';
import ShipmentData from './POSchedule/ShipmentData';
...
function OpenPOListPage({
  apiUrl = "/api/purchaseorders/openpo",
  pageTitle = "Open Purchase Orders",
  pageSubtitle = "Manage schedules, comments, and delayed PO reports",
  tableTitle = "Open Purchase Orders",
  showDelayedReportButton = true,
}) {
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="container mx-auto px-4 py-8 flex-1 flex flex-col">
        <div className="flex items-center justify-between mb-6">
          ...
          {showDelayedReportButton && <DelayedPOReportButton />}
        </div>
