...
function Navigationcomponent() {
  return (
    <div>
      <nav
        className="flex-no-wrap relative flex w-full items-center justify-between bg-slate-100  shadow-md shadow-black/5 dark:bg-neutral-600 dark:shadow-black/10 lg:flex-wrap lg:justify-start"
        data-te-navbar-ref
      >
        <div className="flex w-full flex-wrap items-center justify-between px-6">
          {/* for small devices- hamberger icon  */}
          <button
            className="block border-0 bg-transparent py-1 px-2.5 text-neutral-500 hover:no-underline hover:shadow-none focus:no-underline focus:shadow-none focus:outline-none focus:ring-0 dark:text-neutral-200 lg:hidden"
            type="button"
          ...
          >
            <a
              className="mt-2 mr-6 flex items-center text-neutral-900 hover:text-neutral-900 focus:text-neutral-900 dark:text-neutral-200 dark:hover:text-neutral-400 dark:focus:text-neutral-400 lg:mt-0"
              href="/"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="text-[#24662d]">Home</p>
            </a>
          ...
          <div className="relative flex items-center">
            ...
            <div className="relative" data-te-dropdown-ref>
              ...
              >
                ...
                <p className="text-xs bg-red-600 text-sky-50 py-2 px-3 ">
                  LOGOUT
                </p>
              </a>
