  ...
  useEffect(() => {
    const fetchPurchaserorders = async () => {
      const response = await fetch(
        `/api/purchaseorders/vendor/yearwise2024/${vendornumber}`
      );
          ...
          <div className="flex justify-between">
            ...
            <div className="flex justify-between bg-sky-300 text-[13px] ">
              ...
              <>
                    <div className="flex justify-between">
                      ...
                      <h5 className="text-amber-900 font-bold tracking-wider">
                          {" "}
                          {
                            vendorevaled["powiseevalyear4"]["powiserating"][0]?.ponumber
                      ...
                      <h4 className="px-3 font-bold tracking-wider font-Lato">
                          {" "}
                          {
                            vendorevaled["powiseevalyear4"]["powiserating"][0]?.povalue
                      ...
                      <div className="flex justify-between font-mono text-[14px]">
                        ...
                        <h5 className=" ml-9 font-bold px-3 text-slate-800  mr-3 mb-1">
                          {
                            vendorevaled["powiseevalyear4"]["powiserating"][0]?.deliveryrating
                      ...
                      <div className="flex justify-between font-mono text-[14px]">
                        ...
                        <h5 className="ml-9 font-bold px-3 text-slate-800  mr-3 mb-1">
                          {
                            vendorevaled["powiseevalyear4"]["powiserating"][0]?.pricerating
                      ...
                      <div className="flex justify-between font-mono text-[14px]">
                        ...
                        <h5 className="ml-9 font-bold px-3 text-slate-800  mr-3 mb-1">
                          {
                            vendorevaled["powiseevalyear4"]["powiserating"][0]?.qualityrating
              ...
              <div className="bg-zinc-50/90 flex flex-col mr-2 px-1 shadow-md shadow-zinc-300">
                {vendorevaled["powiseevalyear4"]["powiserating"][1] ? (
                  <div>
                    <>
                    <div className="flex justify-between">
                      <h4 className="font-bold text-zinc-900 mb-3">
              ...
              {/* third PO */}
              <div className="bg-zinc-50/90 flex flex-col mr-2 px-1 shadow-md shadow-zinc-300">
                {vendorevaled["powiseevalyear4"]["powiserating"][2] ? (
                  <div>
                    <>
                    <div className="flex justify-between">
                      <h4 className="font-bold text-zinc-900 mb-3">
...
: (
  <p className="text-[12px] uppercase p-3 font-Lato mx-auto"> No Purchases in year 2024.</p>
)
        )}
      </div>
      </div>
