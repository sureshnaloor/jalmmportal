...
export const navigationSections = {
  ...
  materials: {
    ...
    cards: withColors([
      ...
      {
        href: "/open-stock-balance",
        label: "Open Stock Balance",
        description:
          "As-on-date materials in complete-stock or special-stock — search, multi-sort, table or cards.",
        size: "lg",
      },
      {
      ...
      {
        href: "/material-groups/map-stock-po-materials",
        label: "Map Stock and Open PO Materials",
        description:
          "Assign the 2,739 stock and open-PO materials from the HANA QAS Excel list to subgroups.",
        size: "md",
      },
      {
        href: "/material-groups/map-hana-materials",
        label: "Map HANA Selected Materials",
        description:
          "Map materials from the HANA dev selection Excel list to material group subgroups.",
        size: "md",
      },
      {
      ...
      {
        href: "/reqmatcodeall",
        label: "Request Matcode (All Users)",
        description:
          "Open to all users: describe the material, review similar codes, then generate a SAP-style description.",
        size: "md",
      },
      {
      ...
      },
      {
        ...
        label: "Database Chat",
        description:
          "Ask natural-language questions and fetch from MongoDB collections (read-only MCP).",
        size: "lg",
        color: "emerald",
      },
    ]),
  ...
  purchaseOrders: {
    ...
    cards: withColors([
      ...
      {
        href: "/open-gr-purchaseorders",
        label: "Open GR PO Lines",
        description:
          "Purchase order lines with remaining GR / to-be-delivered qty or value — search and multi-sort.",
        size: "lg",
      },
      {
  ...
  vendors: {
    ...
    cards: withColors([
      ...
      {
        href: "/vendor-evaluation-prior-po",
        label: "Vendor Evaluation — Prev Years POs",
        description:
          "Fresh current-year evaluation for active vendors not covered last calendar year — most recent 2 POs.",
        size: "lg",
      },
      {
        href: "/vendorswithpo",
